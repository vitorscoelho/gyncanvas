...
//Port da lib Earcut4j para triangulizar poligonos
...
//
//        val hasHoles :Boolean= holeIndices != null && holeIndices.size > 0
//        val outerLen:Int = if (hasHoles) holeIndices[0] * dim else  data.size
//
